...
- PROJECT_SLUG: copilot-api-plus-test-test
- UPSTREAM_REPO: CodeEagle/copilot-api-plus-test-test
- UPSTREAM_URL: https://github.com/CodeEagle/copilot-api-plus-test-test
- HOMEPAGE: https://github.com/CodeEagle/copilot-api-plus-test-test
- LICENSE: 
- AUTHOR: TODO
- VERSION: 0.1.0
- IMAGE: TODO
...
## 预填数据路径
- `/root/.local/share/copilot-api-plus-test` <= `/lzcapp/var/data/copilot-api-plus-test` (From source code pattern in paths.ts)
...
- `copilot-api-plus-test`
  image: `registry.lazycat.cloud/placeholder/copilot-api-plus-test:bootstrap`
  binds: `/lzcapp/var/data/copilot-api-plus-test:/root/.local/share/copilot-api-plus-test`
