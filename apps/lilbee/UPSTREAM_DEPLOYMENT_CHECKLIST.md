# lilbee Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: lilbee
- PROJECT_SLUG: lilbee
- UPSTREAM_REPO: tobocop2/lilbee
- UPSTREAM_URL: https://github.com/tobocop2/lilbee
...
## 预填数据路径
- `/data` <= `/lzcapp/var/data/lilbee/lilbee` (From common data path pattern)
- `/root/.local/share/lilbee` <= `/lzcapp/var/data/lilbee` (From source code pattern in system.py)
...
## 当前服务拓扑初稿
- `lilbee`
  image: `registry.lazycat.cloud/placeholder/lilbee:bootstrap`
  binds: `/lzcapp/var/data/lilbee/lilbee:/data, /lzcapp/var/data/lilbee:/root/.local/share/lilbee`
