# MarkItDown Web & MCP Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: MarkItDown Web & MCP
- PROJECT_SLUG: markitdown
...
- `markitdown`
  ...
  binds: `/lzcapp/var/data:/workdir`
  environment: `MARKITDOWN_ENABLE_PLUGINS=true, MARKITDOWN_MAX_UPLOAD_BYTES=26214400`
