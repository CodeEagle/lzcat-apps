# hifi Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: hifi
- PROJECT_SLUG: hifi
- UPSTREAM_REPO: sachinsenal0x64/hifi
- UPSTREAM_URL: https://github.com/sachinsenal0x64/hifi
...
## 当前服务拓扑初稿
- `hifi`
  image: `registry.lazycat.cloud/placeholder/hifi:bootstrap`
