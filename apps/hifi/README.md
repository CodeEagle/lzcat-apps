...
本目录由 `scripts/bootstrap_migration.py` 生成，用于把上游 `sachinsenal0x64/hifi` 初始化为懒猫微服迁移项目。

## 上游项目
- Upstream Repo: sachinsenal0x64/hifi
- Homepage: https://github.com/sachinsenal0x64/hifi
- License: GPL-2.0
...
- Primary Subdomain: `hifi`
- Image Targets: `hifi`
- Service Port: `3000`

### Services
- `hifi` -> `registry.lazycat.cloud/placeholder/hifi:bootstrap`
...
4. 初稿补全后执行 `./scripts/local_build.sh hifi --check-only`，再进入实际构建与验收。
