# cc-gateway Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: cc-gateway
- PROJECT_SLUG: cc-gateway
- UPSTREAM_REPO: motiful/cc-gateway
- UPSTREAM_URL: https://github.com/motiful/cc-gateway
...
## 当前服务拓扑初稿
- `gateway`
  image: `registry.lazycat.cloud/placeholder/cc-gateway:gateway`
