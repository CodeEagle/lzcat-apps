# ShowPilot Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: ShowPilot
- PROJECT_SLUG: showpilot
- UPSTREAM_REPO: ShowPilotFPP/ShowPilot
- UPSTREAM_URL: https://github.com/ShowPilotFPP/ShowPilot
...
## 预填数据路径
- `/app/data` <= `/lzcapp/var/data/showpilot` (From Dockerfile VOLUME)
- `/data` <= `/lzcapp/var/data/showpilot/showpilot` (From common data path pattern)
...
## 当前服务拓扑初稿
- `showpilot`
  image: `registry.lazycat.cloud/placeholder/showpilot:bootstrap`
  binds: `/lzcapp/var/data/showpilot:/app/data, /lzcapp/var/data/showpilot/showpilot:/data`
