# openrun Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: openrun
- PROJECT_SLUG: openrun
- UPSTREAM_REPO: openrundev/openrun
- UPSTREAM_URL: https://github.com/openrundev/openrun
...
## 当前服务拓扑初稿
- `openrun`
  image: `registry.lazycat.cloud/placeholder/openrun:bootstrap`
