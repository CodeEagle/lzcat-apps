# hacktricks Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: hacktricks
- PROJECT_SLUG: hacktricks
- UPSTREAM_REPO: HackTricks-wiki/hacktricks
- UPSTREAM_URL: https://github.com/HackTricks-wiki/hacktricks
...
## 当前服务拓扑初稿
- `hacktricks`
  image: `registry.lazycat.cloud/placeholder/hacktricks:bootstrap`
