# moltnet Upstream Deployment Checklist

## 已确认字段
- PROJECT_NAME: moltnet
- PROJECT_SLUG: moltnet
- UPSTREAM_REPO: noopolis/moltnet
- UPSTREAM_URL: https://github.com/noopolis/moltnet
...
## 当前服务拓扑初稿
- `moltnet-web`
  image: `registry.lazycat.cloud/placeholder/moltnet:bootstrap`
